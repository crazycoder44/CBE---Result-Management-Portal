...
{ 
$subid=$_GET['id'];
$sql="delete from subjects where sub_id = :subid";
...
<html lang="en">
    <head>
        ...
        <title> SRMS | Manage Subjects </title>
...
<td>
<a href="edit-subject.php?subjectid=<?php echo htmlentities($result->sub_id);?>" class="btn btn-info btn-xs">Edit  </a> 
