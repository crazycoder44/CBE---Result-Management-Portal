...
if(@$_GET['q']==6) {
    ...
    echo '<div class="col-md-4">';
    echo '<button type="submit" name="download" class="btn btn-primary">Download Cummulative</button>';
    echo '</div>';
    echo '</div>';
...
if (isset($_GET['q']) && $_GET['q'] == '6' && isset($_GET['session']) && isset($_GET['term'])) {
    ...
    header('Location: cummulative_session.php'); // Redirect after processing
