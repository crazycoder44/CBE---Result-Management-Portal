  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <!--<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;<b>Result</b></a></li>-->
...
<!-- <div class="modal fade title1" id="abtus">
  <div class="modal-dialog">
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
    <a style="color:orange; font-family:'typo' ; font-size:20px" title="Find on Facebook"><b>SRMS CBE Portal</b></a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="">SRMS CBE Portal Is a Programme Developed By CrazyCoder. 
    ...
    <h4 style="font-family:'typo' ">Copyright &copy;<script>document.write(new Date().getFullYear());</script> - 
    <a href="mailto:crazycoder44@gmail.com">crazycoder44@gmail.com</a></h4></div></div>
    </p>
      </div> -->
