...
<div class="panel-body p-20">
    <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
        <?php 
        // Fetch classes and their corresponding guardian names in one query
        $sql = "SELECT c.classid, c.class, c.arm, c.staffid, s.fname, s.lname 
                FROM class c 
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $result) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit-class.php?classid=<?php echo htmlentities($result->classid); ?>" class="btn btn-info btn-xs"> Edit </a>
                        <a href="view-class.php?classid=<?php echo htmlentities($result->classid); ?>" class="btn btn-success btn-xs"> View </a>
                    </td>
                </tr>
                <?php $cnt++; 
            }
