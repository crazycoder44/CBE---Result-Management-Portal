...
if(strlen($_SESSION['alogin'])=="") {   
    ...
    if(isset($_POST['submit'])) {
        ...
        // Prepare SQL query
        $sql = "INSERT INTO staff(staffid, fname, lname, gender, email, phone, password) 
                VALUES(:staffid, :fname, :lname, :gender, :email, :mobile, :password)";
        $query = $dbh->prepare($sql);

        $sql2 = "INSERT INTO admin(email, password, staffid, fname)
                    VALUES(:email, :password,:staffid, :fname)";
...
<head>
    ...
    <title>SMS Admin | Staff Admission</title>
...
<body class="top-navbar-fixed">
    <div class="main-wrapper">
        ...
        <!-- ========== WRAPPER FOR BOTH staffidEBARS & MAIN CONTENT ========== -->
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Staff Entry</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="staffid" class="form-control" id="staffid" required="required" autocomplete="off">
                                                </div>
                                            </div>
