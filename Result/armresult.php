<?php
session_start();
// Function to generate grade and remark based on marks and thresholds
...
unset($_SESSION['results']); // Clear the session data
...
$studentname = htmlspecialchars($results['studentname'], ENT_QUOTES, 'UTF-8');
$sid = htmlspecialchars($results['sid'], ENT_QUOTES, 'UTF-8');
$class = htmlspecialchars($results['class'], ENT_QUOTES, 'UTF-8');
$noinclassarm = htmlspecialchars($results['noinclassarm'], ENT_QUOTES, 'UTF-8');
$termname = htmlspecialchars($results['termname'], ENT_QUOTES, 'UTF-8');
$sessionvalue = htmlspecialchars($results['session'], ENT_QUOTES, 'UTF-8');
$total_marks_obtainable = htmlspecialchars($results['total_marks_obtainable'], ENT_QUOTES, 'UTF-8');
$total_marks_obtained = htmlspecialchars($results['total_marks_obtained'], ENT_QUOTES, 'UTF-8');
$average = htmlspecialchars(round($results['average'], 2), ENT_QUOTES, 'UTF-8');
$suffixedClassArmPosition = htmlspecialchars($results['suffixedClassArmPosition'], ENT_QUOTES, 'UTF-8');
...
<body>
<div class="container">
    <div class="card" id="armResult">
        <div class="card-header">
            <h1>TEST COLLEGE</h1>
            <p>00, Sample Street, Compton, Mars</p>
            <p>Building projects to improve education in Mars</p>
            <h2 style="color: red">TERMINAL REPORT</h2>
        </div>
        <table class="info-table">
            <thead style="font-weight: bold;">
                <tr>
                    <th colspan="2">NAME OF STUDENT: <?php echo $studentname; ?></th>
                    <th>ADMISSION NUMBER: <?php echo $sid; ?></th>
                    <td colspan="2">CLASS: <?php echo $class; ?></td>
                </tr>
                <tr>
                    <td colspan="2">NUMBER IN CLASS: <?php echo $noinclassarm; ?></td>
                    <td>TERM: <?php echo $termname; ?></td>
                    <td colspan="2">SESSION: <?php echo $sessionvalue; ?></td>
                </tr>
                <tr>
                    <td>TOTAL MARKS OBTAINABLE: <?php echo $total_marks_obtainable; ?></td>
                    <td>TOTAL MARKS OBTAINED: <?php echo $total_marks_obtained; ?></td>
                    <td>AVERAGE: <?php echo $average; ?></td>
                    <td>POSITION: <?php echo $suffixedClassArmPosition; ?></td>
