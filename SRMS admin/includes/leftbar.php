...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="approve_results.php"><i class="fa fa-bars"></i> <span>Approve Results</span></a></li>
                                            <li><a href="prep_broad.php"><i class="fa fa-bars"></i> <span>Term Broadsheet</span></a></li>
                                            <li><a href="prep_cum.php"><i class="fa fa fa-server"></i> <span>Cummulative Broadsheet</span></a></li>
...
<li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="add-resumption.php"><i class="fa fa-bars"></i> <span>Add Resumption Date</span></a></li>
