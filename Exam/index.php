...
<title>CBT Portal || CrazyCoder </title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/dev.jpg" width=100 height=100 alt="Developer" title="Vincent Okoli" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" target="_blank" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Vincent Okoli</a>
		...
		<h4 style="font-family:'typo' ">Beginner Developer</h4></div></div>
		</p>
      </div>
...
<div class="modal fade title1" id="abtus">
  <div class="modal-dialog">
    ...
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="">CBE Portal Is A CBE Programme System Developed By CrazyCoder. Its Aim Is To Bring The Students And Teachers Into A Circle Of Vast Experience, where Teachers Can Set Quiz and students can write exams set by their teachers</h4>
    <h4 style="font-family:'typo' ">Copyright &copy;<script>document.write(new Date().getFullYear());</script> - <a href="mailto:crazycoder44@gmail.com">crazycoder44@gmail.com</a></h4></div></div>
    </p>
      </div>
