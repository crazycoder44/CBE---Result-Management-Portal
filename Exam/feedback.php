...
<title>FEEDBACK || Dominican Portal</title>
...
<div class="col-lg-12">
<span class="logo">CBT Portal</span><?php
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
  <a href="https://www.facebook.com/dickbassey.7" target="_blank" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dick Bassey</a>
    ...
    <h4 style="font-family:'typo' ">Senior Programmer At Anonyx Software Enterprises, Nigeria.</h4></div></div>
    </p>
      </div>
      <div class="modal-body">
        <p>
    <div class="row">
    <div class="col-md-4">
     <img src="" width=100 height=100 alt="Developer" title="Dick Bassey" class="img-rounded">
     </div>
     <div class="col-md-5">
  <a href="" target="_blank" style="color:#202020; font-family:'typo' ; font-size:18px" title="#">Vincent Okoli</a>
    ...
    <h4 style="font-family:'typo' ">crazycoder44@gmail.com</h4>
    <h4 style="font-family:'typo' ">Junior Programmer At Anonyx Software Enterprises, Nigeria.</h4></div></div>
    </p>
      </div>
      <div class="modal-body">
        <p>
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
  <a href="" target="_blank" style="color:#202020; font-family:'typo' ; font-size:18px" title="#">Kelechi Emecheta</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+234 9021131159</h4>
    <h4 style="font-family:'typo' ">crazycoder44@gmail.com</h4>
    <h4 style="font-family:'typo' ">Junior Programmer At Anonyx Software Enterprises, Nigeria.</h4></div></div>
    </p>
      </div>
...
<div class="modal fade title1" id="abtus">
  <div class="modal-dialog">
    ...
    <div class="col-md-4">
     ...
     <div class="col-md-5">
    <a style="color:orange; font-family:'typo' ; font-size:20px" title="Find on Facebook"><b>Dominican CBT Portal</b></a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="">Dominican CBT Portal Is a Programme Developed By Anonyx Software Enterprises. 
      Its aim is to improve the teaching and learning of students and teachers respectively. 
      Teachers can get the experience of preparing Computer Based Exams and students can also get the experience of writing Computer Based Exams which is mostly used by Local and International Certificate Examination bodies such as WAEC.
