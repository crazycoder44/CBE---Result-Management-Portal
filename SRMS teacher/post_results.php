...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    foreach ($students as $student) {
        ...
        $total = mysqli_real_escape_string($con, $student['total']);
        $grade = mysqli_real_escape_string($con, $student['grade']);
        ...
        $query = "
            INSERT INTO tempresult (email, session, termid, classid, sub_id, ca, examobj, examtheory, total, grade)
            VALUES ('$email', '$session', '$term', '$classid', '$sub_id', '$ca', '$examobj', '$examtheory', '$total', '$grade')
